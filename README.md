...
The latest version of the library is 0.58, and it may be obtained from the Maven Central repository.
...
### Gradle
```groovy
    implementation 'net.pwall.json:json-kotlin-schema:0.58'
```
### Gradle (kts)
```kotlin
    implementation("net.pwall.json:json-kotlin-schema:0.58")
